...
export function SphereAnimation() {
  ...
  useEffect(() => {
    ...
    const onPointerDown = (e: MouseEvent | TouchEvent) => {
      ...
      startX = point.clientX - initialX;
      startY = point.clientY - initialY;
    ...
    sphereEl.addEventListener('mousedown', onPointerDown);
    document.addEventListener('mousemove', onPointerMove);
    document.addEventListener('mouseup', onPointerUp);

    sphereEl.addEventListener('touchstart', onPointerDown, { passive: false });
    ...
    const sphereAnimation = () => {
      ...
      return () => {
        ...
        sphereEl.removeEventListener('mousedown', onPointerDown);
        document.removeEventListener('mousemove', onPointerMove);
        document.removeEventListener('mouseup', onPointerUp);
        sphereEl.removeEventListener('touchstart', onPointerDown);
        document.removeEventListener('touchmove', onPointerMove);
        document.removeEventListener('touchend', onPointerUp);
      };
    };

    const cleanupAnimation = sphereAnimation();
    return cleanupAnimation;
  }, []);

  return (
    <div className="animation-wrapper" ref={animationRef}>
      <div className="sphere-animation" ref={sphereElRef}>
        <svg
          className="sphere"
          viewBox="0 0 440 440"
        ...
        >
          <defs>
            <linearGradient id="sphereGradient" x1="5%" x2="5%" y1="0%" y2="15%">
              ...
              <stop stopColor="hsl(var(--sidebar-background))" offset="100%" />
            </linearGradient>
          </defs>
